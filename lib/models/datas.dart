...
class Datas {
  ...
  static String athenes = 'app_assets/images/Greek Cities/Athens.jpg';
  static String corfou = 'app_assets/images/Greek Cities/Corfou.jpg';
  static String delphi = 'app_assets/images/Greek Cities/Delphi.jpg';
  static String meteores = 'app_assets/images/Greek Cities/Meteores.jpg';
  static String santorin = 'app_assets/images/Greek Cities/Santorin.jpg';
  static String sounion = 'app_assets/images/Greek Cities/Sounion.jpg';
  ...
  Widget router(String title, Widget child) {
    switch (title) {
      case 'Animated Container':
        return BlocProvider<BlocAnimatedContainer>(
          onDispose: (_, bloc) => bloc.dispose(),
          builder: (_, bloc) => BlocAnimatedContainer(),
          child: child,
        );
      case 'Opacity':
        return BlocProvider<BlocOtherAnimated>(
          onDispose: (_, bloc) => bloc.dispose(),
          builder: (_, bloc) => BlocOtherAnimated(),
          child: child,
        );
      default:
        return child;
...
//        return BlocProvider<BlocOtherAnimated>(
//            bloc: BlocOtherAnimated(), child: child);
//        return child;
    }
  }
  ...
  List<GreekCity> cities = [
    ...
    GreekCity("Meteores", meteores,
        "Les Météores sont une formation géologique du nord de la Grèce, en Hestiotide, dans la vallée du Pénée. Ils abritent des monastères chrétiens orthodoxes perchés au sommet de falaises et pitons rocheux gris, sculptés par l'érosion. Le site est inscrit au patrimoine mondial de l'UNESCO depuis 1988"),
    GreekCity("Sounion", sounion,
        "Le cap Sounion est un cap de Grèce qui s'avance à 45 kilomètres au sud-est d’Athènes dans la mer Égée et qui constitue l'extrémité de l'Attique. Il est surtout renommé pour les ruines d'un temple dédié à Poséidon. Il est classé parmi les parcs nationaux de Grèce."),
